...
export default function Footer() {
    ...
    return (
        <footer className={`${pathname.includes("admin") && "hidden"} min-h-[41rem] bg-no-repeat bg-cover bg-bottom grid place-items-center`} style={{
            ...
            <div className="flex flex-col md:flex-row flex-wrap gap-10 items-start justify-between p-10 pt-20 w-full h-full bg-white bg-opacity-60">
                ...
                <div className='text-lg space-y-3'>
                    ...
                    <p>2025 Willingdon Ave, Suite 900, Burnaby, <br /> British Columbia V5C 0J3, CA</p>
