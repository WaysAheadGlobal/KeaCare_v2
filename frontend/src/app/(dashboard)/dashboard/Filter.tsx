...
export default function Filter({ filters, setFilters }: { filters: any, setFilters: any }) {
    ...
    return (
        <section key={key} id="filters" className='absolute top-4 left-4 h-fit p-5 w-[20rem] md:static flex flex-col items-start gap-4 bg-gray-200 border-[1px] border-black rounded-lg transition-transform md:translate-x-0 -translate-x-[9999px]'>
