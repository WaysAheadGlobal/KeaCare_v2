...
export default function AboutUs() {
    return (
        <>
            <div id="about" className='-mt-5'>{"    "}</div>
            <section className="flex flex-col h-[70rem] lg:h-auto lg:grid lg:grid-cols-2 gap-[5rem] p-[2rem] md:p-[5rem] bg-teal-500 bg-opacity-30">
