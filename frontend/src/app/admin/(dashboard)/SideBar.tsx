    ...
    return (
        <section className="bg-teal-500 py-[2rem] hidden sm:block">
            <div className='sticky top-16'>
                ...
                <Link href="/admin/vettinglist.html" className={`flex p-2 px-[2rem] items-center gap-2 ${pathname.includes("/admin/vettinglist.html") ? "bg-white text-teal-500" : "text-white"}`}>
