...
export default function HowItWorks() {
    ...
    return (
        <motion.section id="working" className='px-5 pt-20 sm:py-20 xl:p-20 flex flex-col gap-10'
            ref={ref}
            variants={{
                        ...
                        <div className='xl:p-20 py-10 px-5 flex flex-col gap-10 items-center justify-center'>
                            <div className='flex flex-row gap-2 items-center justify-center'>
                                ...
                                <div className='text-white flex flex-col items-start justify-center'>
                                    <p className='sm:text-xl font-semibold'>Search in your Area</p>
                                    <p className='text-sm sm:text-lg'>Search the childcare or senior care profiles in your area based on your requirement</p>
                                </div>
                            </div>
                            <div className='flex flex-row gap-2 items-center justify-center'>
                                ...
                                <div className='text-white flex flex-col items-start justify-center'>
                                    <p className='sm:text-xl font-semibold'>Use the necessary filters</p>
                                    <p className='text-sm sm:text-lg'>Filters the profiles based on experience, rating, age, type, language, and additional services</p>
                                </div>
                            </div>
                            <div className='flex flex-row gap-2 items-center justify-center'>
                                ...
                                <div className='text-white flex flex-col items-start justify-center'>
                                    <p className='sm:text-xl font-semibold'>Book a session</p>
                                    <p className='text-sm sm:text-lg'>View the caregiver profile details based on search or recommendation and tap the &quot;book appointment&quot; button to confirm your appointment</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-rows-[0.7fr_1fr] grid-cols-1 xl:grid-cols-2 xl:grid-rows-1 bg-teal-500 rounded-xl xl:rounded-[20rem_0_0_8px] xl:rounded-r-xl'>
                        ...
                        <div className='xl:p-20 px-5 py-10 flex flex-col gap-10 items-center justify-center'>
                            <div className='flex flex-row gap-2 items-center justify-center'>
                                ...
                                <div className='text-white flex flex-col items-start justify-center'>
                                    <p className='sm:text-xl font-semibold'>Search jobs in your Area</p>
                                    <p className='text-sm sm:text-lg'>Search the childcare or senior care job in your area based on your expertise</p>
                                </div>
                            </div>
                            <div className='flex flex-row gap-2 items-center justify-center'>
                                <Image src={necessaryFilters.src} width={necessaryFilters.width} height={necessaryFilters.height} alt='Use the necessary filters' className='w-[4rem] md:w-[6rem]' />
                            ...
                            <div className='flex flex-row gap-2 items-center justify-center'>
                                ...
                                <div className='text-white flex flex-col items-start justify-center'>
                                    <p className='sm:text-xl font-semibold'>Apply for the job!</p>
                                    <p className='text-sm sm:text-lg'>View the job posting done by care seeker and apply for the job</p>
                                </div>
                            </div>
                        </div>
