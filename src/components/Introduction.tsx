...
export default function Introduction() {
    ...
    return (
        <div className='grid grid-rows-2 md:flex md:flex-row md:relative md:mx-[9.5rem] h-[45rem] p-5'>
            <div className='w-full md:w-[30rem] bg-teal-500 md:h-[18rem] rounded-b-lg md:rounded-[0_0_20rem_0] row-[2/3]'>
                <div className='flex flex-col gap-2 p-3 items-start'>
                    <h1 className='text-white text-4xl font-semibold'>On-demand</h1>
                    <h1 className='text-white text-4xl font-semibold'>platform of vetted</h1>
                    <h1 className='text-white text-4xl font-semibold'>caregivers</h1>
            ...
            <Image id="ladyWithBaby" src={ladywithBaby} alt='old lady' width={ladywithBaby.width} height={ladywithBaby.height} className='hidden row-[1/2] rounded-t-lg md:rounded-[0_0_0_20rem] h-full md:h-[40rem] md:absolute z-[-1] md:w-[56rem] left-[18rem]' />
        </div>
    )
}
