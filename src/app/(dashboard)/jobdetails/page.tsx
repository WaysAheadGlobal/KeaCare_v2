...
import { FormControlLabel, FormGroup, MenuItem, OutlinedInput, Select, Checkbox } from "@mui/material";
                ...
                <form className='px-[2rem] md:px-[8rem] py-[1rem]'
                    ...
                    onSubmit={async (e) => {
                        ...
                        const bodyContent = JSON.stringify({
                            ...
                            hourlyRate: rate,
                            jobDateStart: date.split(",")[0],
                            jobDateEnd: date.split(",")[date.split(",").length - 1],
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 grid-rows-[auto] gap-5 mt-[1.5rem]'>
                        ...
                        <div className='w-full'>
                            ...
                            <input name="hourlyRate" id="hourlyRate" value={job?.hourlyRate} required className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit px-3 invalid:focus:outline-red-500' onChange={(e) => {
                    ...
                    <section className='mt-[4rem] flex flex-col gap-[1rem] items-start'>
                        ...
                        <button disabled className='bg-teal-500 disabled:bg-opacity-25 text-white px-5 py-3 rounded-lg'>Update this Job</button>
                    </section>
                </form>
            </section>
        </>
