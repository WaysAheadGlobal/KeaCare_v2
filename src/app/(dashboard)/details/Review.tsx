    ...
    return (
        <div className='p-[1rem] w-full md:w-[25rem] flex flex-col gap-[1.5rem] bg-teal-500 bg-opacity-50 rounded-lg hover:shadow-lg transition-shadow'>
            <div className='flex gap-5 items-center justify-start'>
                <Image src={review.imageUrl ? review.imageUrl : defaultUser} alt={review.fname + " " + review.lname} width={100} height={100} className='w-[4rem] aspect-square rounded-full object-cover object-top' />
