...
export default function Details() {
    ...
    return (
        <section className='md:flex md:flex-col items-center px-[1rem] lg:px-[5rem]'>
            ...
            <dialog id="reviewDialogBox" className='p-1 rounded-lg w-full md:max-w-[35rem]'>
                <div className='flex flex-col w-full'>
                    ...
                    <form
                        ...
                        <div className='space-y-1 w-full h-full'>
                            <p>Write a Review.</p>
                            <textarea name="review" rows={10} className="border-2 p-[0.75rem] border-teal-500 hover:ring-2 hover:ring-teal-300 focus:ring-2 focus:ring-teal-300 outline-none rounded-lg w-full h-[10rem]" placeholder="Write a Review"></textarea>
                        </div>
