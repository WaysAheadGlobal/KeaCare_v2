    ...
    return (
        ...
        >
            ...
            <div className='flex flex-col flex-wrap items-center justify-center md:items-stretch md:flex-row gap-5'>
                ...
                <Card image={leader2} heading='Tran Thuong Thu Giang' subHeading='Chief Executive Officer' text='Tran Thuong Thu Giang is the Chief Technology Officer at KEACARE. She has spent over 15 years working in information technology and software development across a range of industries, and hold an MSc in Computer Science from Vrije Universiteit, in Belgium.' delay={0.25} socialmedia={["https://www.linkedin.com/in/thu-giang-tran-thuong-96ba368/", "https://www.linkedin.com/in/thu-giang-tran-thuong-96ba368/", "https://www.linkedin.com/in/thu-giang-tran-thuong-96ba368/"]} />
