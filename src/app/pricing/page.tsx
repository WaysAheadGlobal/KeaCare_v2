...
function Card({ price, heading }: { price: string, heading: string }) {
    return (
        <>
            <div className='rounded-xl w-[20rem] p-5 flex flex-col gap-10 transition-shadow hover:shadow-2xl bg-white'>
                ...
                <button className='border-2 hover:border-teal-500 hover:text-teal-500 hover:bg-white border-white bg-teal-500 text-white px-5 py-3 rounded-lg'>Buy Now</button>
            </div>
        </>
    )
}
