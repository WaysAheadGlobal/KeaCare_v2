...
export default function PostJob() {
    ...
    return (
        <form className='px-[2rem] md:px-[8rem] py-[2rem]' onSubmit={async (e) => {
            e.preventDefault();
            ...
            const comfortableWithPets = (document.getElementById("comfortableWithPets") as HTMLSelectElement).value === "yes" ? true : false;
            ...
            const response = await fetch("http://localhost:3001/api/careseeker/postjob", {
                method: "POST",
                headers: {
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 grid-rows-[auto] gap-5 mt-[1.5rem]'>
                <div className='w-full'>
                    ...
                    <select id="speciality" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit'>
                        <option value="Select">Select</option>
                        <option value="child_care">Child Care</option>
                        <option value="senior_care">Senior Care</option>
                    </select>
                </div>
                <MultiSelect radius="md" size='md'
                    styles={{
                        input: {
                            borderColor: "black",
                            ":focus-within": {
                ...
                <div className='w-full'>
                    ...
                    <input name="rate" id="rate" defaultValue={0} className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit px-3' onChange={(e) => {
                        setRate(parseInt(e.currentTarget.value));
                    }} />
                </div>
                <div className='w-full'>
                    <p>Experience.</p>
                    <select name="experience" id="experience" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit'>
                        <option value="Select">Select</option>
                ...
                <div className='w-full'>
                    <p>Age.</p>
                    <select name="age" id="age" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit'>
                        <option value="Select">Select</option>
                ...
                <div className='w-full'>
                    <p>Location.</p>
                    <input name="location" id="location" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit px-3' placeholder='Enter Zip Code' />
                </div>
                <div className='w-full sm:row-[3/4]'>
                    <p>Rating.</p>
                    <select name="rating" id="rating" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit'>
                        <option value="Select">Select</option>
                ...
                <div className='w-full sm:row-[3/4] sm:col-[2/3]'>
                    <p>Availability.</p>
                    <select name="availability" id="availability" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit'>
                        <option value="Select">Select</option>
                ...
                <div>
                    ...
                    <select name="comfortableWithPets" id="comfortableWithPets" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit'>
                        <option value="Select">Select</option>
            ...
            <div className='mt-[1.5rem]'>
                <p>Job Description</p>
                <textarea name="jobDescription" id="jobDescription" className='w-full min-h-[15rem] bg-inherit border-[1px] p-3 border-black rounded-lg'></textarea>
            </div>
            ...
            <section className='space-y-[1rem]'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-[min-content_auto_auto] grid-rows-[auto] gap-[4rem]'>
                    ...
                    <div className=' flex flex-col gap-5'>
                        ...
                        <select key={selected.toString()} name="time" id="time" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit' onChange={(e) => {
                            setInfo([...info, {
                                [dayjs(selected[selected.length - 1]).format("DD/MM/YYYY")]: e.currentTarget.value
                            }])
                        }}>
                            <option value="select">Select</option>
                            <option value="full">Entire Day</option>
                            <option value="AM_10_11">10 am to 11 am</option>
                            <option value="AM_11_12">11 am to 12 noon</option>
                            <option value="PM_12_1">12 noon to 1 pm</option>
                            <option value="PM_1_2">1 pm to 2 pm</option>
                            <option value="PM_2_3">2 pm to 3 pm</option>
                            <option value="PM_3_4">3 pm to 4 pm</option>
                            <option value="PM_4_5">4 pm to 5 pm</option>
                            <option value="PM_5_6">5 pm to 6 pm</option>
                        </select>
                    </div>
                                ...
                                info.map(element => {
                                    ...
                                    return (
                                        <div key={Object.keys(element)[0]} className='flex justify-between'>
                                            ...
                                            <p className='self-end text-teal-500 mt-5'>{parseInt(time[2]) - parseInt(time[1])} Hours</p>
                                        </div>
                                    )
                                })
                            }
            ...
            <section className='mt-[4rem] flex flex-col gap-[1rem] items-start'>
                ...
                <button className='bg-teal-500 text-white px-5 py-3 rounded-lg'>Post this Job</button>
            </section>
        </form>
    )
}
