...
export default function PostJob() {
    ...
    return (
        <section className='relative'>
            ...
            <form className='px-[2rem] md:px-[8rem] py-[1rem]' onSubmit={async (e) => {
                e.preventDefault();
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 grid-rows-[auto] gap-5 mt-[1.5rem]'>
                    <div className='w-full'>
                        ...
                        <select id="speciality" className='w-full py-[0.75rem] border-[1px] border-black rounded-lg bg-inherit invalid:focus:outline-red-500' required>
